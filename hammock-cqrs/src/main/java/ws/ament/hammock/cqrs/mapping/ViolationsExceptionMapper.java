...
@Provider
@Mapper
public class ViolationsExceptionMapper implements ExceptionMapper<ViolationException> {
    @Override
    public Response toResponse(ViolationException e) {
        Entity<Violations> entity = Entity.entity(e.getViolations(), MediaType.APPLICATION_JSON_TYPE);
